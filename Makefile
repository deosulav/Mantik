...
build-example:
	clang++ ${ex_src}/main.cpp ${ex_src}/color_node_editor.cpp src/imgui/*.cpp src/imnodes/*.cpp -Iinclude -Iinclude/imgui -Iinclude/imnodes -lSDL2 -lGL -lGLU -lGLEW -o bin/ProteusClone
