...
int node_manager::add_node(int& node_id, std::string name, node_types n_typ) {
	int temp = 0;
...
int node_manager::add_input_pins(int& node_id, int pin_id, std::string pin_name, int value) {
	for (node* n : nodes) {
...
int node_manager::add_output_pins(int& node_id, int pin_id, std::string pin_name, int value) {
	for (node* n : nodes) {
		if (n->m_unique_id == node_id) {
...
int node_manager::add_link(int& m_id, int st_node, int st_pin, int ed_node, int ed_pin) {
	for (node* n : nodes) {
